...
@Component({
  selector: 'app-sitemap-recently-sold',
  standalone: true,
  imports: [CommonModule, RouterModule, SiteHeaderComponent, SiteFooterComponent],
  templateUrl: './sitemap-recently-sold.component.html',
  styleUrls: ['./sitemap-recently-sold.component.css']
})
export class SitemapRecentlySoldComponent {
  states: State[] = [
    {
    ...
    },
    {
      ...
      cities: [
        { name: 'Jacksonville', slug: 'Jacksonville_FL' },
