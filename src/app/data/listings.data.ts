...
const LISTINGS_DATA: Record<string, CategoryInfo> = {
  ...
  'recently-sold': {
    ...
    properties: [
      ...
      { id:10, image:'https://picsum.photos/id/84/600/400', price:'$675,000', address:'57 Harbor Blvd', city:'Long Beach, CA 90802', beds:4, baths:3, sqft:'2,300', badge:'Sold', badgeClass:'badge-green', ...agent(3) },
      { id:1, image:'https://picsum.photos/id/75/600/400', price:'$742,000', address:'44 Westbrook Lp', city:'Seattle, WA 98105', beds:4, baths:3, sqft:'2,500', badge:'Sold', badgeClass:'badge-green', ...agent(0) },
      { id:12, image:'https://picsum.photos/id/76/600/400', price:'$528,000', address:'19 Waverly Pl', city:'Austin, TX 78702', beds:3, baths:2, sqft:'1,750', badge:'Sold', badgeClass:'badge-green', ...agent(1) },
  ...
  'rent': {
    slug: 'rent', label: 'Rentals', count: 480,
  ...
  'buy': {
    ...
    properties: [
      ...
      { id:7, image:'https://picsum.photos/id/1011/600/400', price:'$450,000', address:'100 Main St', city:'Sunnyvale, CA 94086', beds:2, baths:1, sqft:'1,100', badge:'Price Drop', badgeClass:'badge-red', ...agent(1), type:'Condo for sale', builder:'Brokered by ReMax' },
      { id:8, image:'https://picsum.photos/id/1012/600/400', price:'$685,000', address:'200 Elm St', city:'Sunnyvale, CA 94086', beds:3, baths:2, sqft:'1,600', badge:'New', badgeClass:'badge-blue', ...agent(2), type:'House for sale', builder:'Brokered by Coldwell Banker' },
      { id:9, image:'https://picsum.photos/id/1013/600/400', price:'$1,250,000', address:'300 Oak Ave', city:'Sunnyvale, CA 94086', beds:4, baths:3, sqft:'2,400', badge:'Open House', badgeClass:'badge-green', ...agent(3), type:'House for sale', builder:'Brokered by Compass' },
      { id:10, image:'https://picsum.photos/id/1014/600/400', price:'$899,000', address:'400 Pine Dr', city:'Sunnyvale, CA 94086', beds:3, baths:2.5, sqft:'1,900', badge:'New', badgeClass:'badge-blue', ...agent(4), type:'Townhouse for sale', builder:'Brokered by Century 21' },
      { id:11, image:'https://picsum.photos/id/1015/600/400', price:'$540,000', address:'500 Cedar Ln', city:'Sunnyvale, CA 94086', beds:2, baths:2, sqft:'1,200', badge:'Price Drop', badgeClass:'badge-red', ...agent(5), type:'Condo for sale', builder:'Brokered by Redfin' },
      { id:12, image:'https://picsum.photos/id/1016/600/400', price:'$2,100,000', address:'600 Maple St', city:'Sunnyvale, CA 94086', beds:5, baths:4, sqft:'3,200', badge:'Premium', badgeClass:'badge-blue', ...agent(0), type:'House for sale', builder:'Brokered by Sotheby\'s' },
      { id:13, image:'https://picsum.photos/id/1018/600/400', price:'$775,000', address:'700 Birch Way', city:'Sunnyvale, CA 94086', beds:3, baths:2, sqft:'1,750', badge:'New', badgeClass:'badge-green', ...agent(1), type:'House for sale', builder:'Brokered by eXp Realty' },
      { id:14, image:'https://picsum.photos/id/1019/600/400', price:'$920,000', address:'800 Walnut Rd', city:'Sunnyvale, CA 94086', beds:4, baths:2, sqft:'2,100', badge:'Open House', badgeClass:'badge-blue', ...agent(2), type:'House for sale', builder:'Brokered by Keller Williams' },
      { id:15, image:'https://picsum.photos/id/1020/600/400', price:'$615,000', address:'900 Spruce Ave', city:'Sunnyvale, CA 94086', beds:2, baths:1.5, sqft:'1,300', badge:'Price Drop', badgeClass:'badge-red', ...agent(3), type:'Townhouse for sale', builder:'Brokered by Intero Real Estate' },
      { id:16, image:'https://picsum.photos/id/1021/600/400', price:'$1,150,000', address:'101 Ash Blvd', city:'Sunnyvale, CA 94086', beds:4, baths:3, sqft:'2,500', badge:'New', badgeClass:'badge-green', ...agent(4), type:'House for sale', builder:'Brokered by Zillow Premier' },
      { id:17, image:'https://picsum.photos/id/1022/600/400', price:'$840,000', address:'202 Cherry Cir', city:'Sunnyvale, CA 94086', beds:3, baths:2.5, sqft:'1,850', badge:'New', badgeClass:'badge-blue', ...agent(5), type:'House for sale', builder:'Brokered by ERA Real Estate' },
      { id:18, image:'https://picsum.photos/id/1023/600/400', price:'$490,000', address:'303 Fir Pl', city:'Sunnyvale, CA 94086', beds:1, baths:1, sqft:'900', badge:'Open House', badgeClass:'badge-blue', ...agent(0), type:'Condo for sale', builder:'Brokered by Berkshire Hathaway' },
      { id:19, image:'https://picsum.photos/id/1024/600/400', price:'$1,650,000', address:'404 Poplar Dr', city:'Sunnyvale, CA 94085', beds:5, baths:3, sqft:'2,900', badge:'New', badgeClass:'badge-green', ...agent(1), type:'House for sale', builder:'Brokered by Alain Pinel' },
      { id:20, image:'https://picsum.photos/id/1025/600/400', price:'$735,000', address:'505 Willow Ct', city:'Sunnyvale, CA 94086', beds:3, baths:2, sqft:'1,550', badge:'Price Drop', badgeClass:'badge-red', ...agent(2), type:'House for sale', builder:'Brokered by First Team' },
      { id:21, image:'https://picsum.photos/id/1026/600/400', price:'$950,000', address:'606 Redwood Ter', city:'Sunnyvale, CA 94085', beds:4, baths:2.5, sqft:'2,200', badge:'New', badgeClass:'badge-blue', ...agent(3), type:'House for sale', builder:'Brokered by Sereno Group' },
      { id:22, image:'https://picsum.photos/id/1027/600/400', price:'$1,050,000', address:'707 Sequoia Ave', city:'Sunnyvale, CA 94086', beds:4, baths:3, sqft:'2,350', badge:'Open House', badgeClass:'badge-green', ...agent(4), type:'House for sale', builder:'Brokered by Redfin' },
      { id:23, image:'https://picsum.photos/id/1028/600/400', price:'$580,000', address:'808 Magnolia Sq', city:'Sunnyvale, CA 94085', beds:2, baths:2, sqft:'1,350', badge:'Price Drop', badgeClass:'badge-red', ...agent(5), type:'Townhouse for sale', builder:'Brokered by Century 21' },
      { id:24, image:'https://picsum.photos/id/1029/600/400', price:'$1,850,000', address:'909 Sycamore Pt', city:'Sunnyvale, CA 94087', beds:5, baths:4.5, sqft:'3,400', badge:'Premium', badgeClass:'badge-blue', ...agent(0), type:'House for sale', builder:'Brokered by Compass' },
      { id:25, image:'https://picsum.photos/id/1031/600/400', price:'$699,000', address:'110 Acacia Way', city:'Sunnyvale, CA 94086', beds:3, baths:1.5, sqft:'1,450', badge:'New', badgeClass:'badge-green', ...agent(1), type:'House for sale', builder:'Brokered by eXp Realty' },
      { id:26, image:'https://picsum.photos/id/1032/600/400', price:'$1,120,000', address:'220 Beech St', city:'Sunnyvale, CA 94087', beds:4, baths:3, sqft:'2,600', badge:'Open House', badgeClass:'badge-blue', ...agent(2), type:'House for sale', builder:'Brokered by Coldwell Banker' },
      { id:27, image:'https://picsum.photos/id/1033/600/400', price:'$415,000', address:'330 Cottonwood Dr', city:'Sunnyvale, CA 94085', beds:1, baths:1, sqft:'850', badge:'Price Drop', badgeClass:'badge-red', ...agent(3), type:'Condo for sale', builder:'Brokered by ReMax' },
      { id:28, image:'https://picsum.photos/id/1035/600/400', price:'$890,000', address:'440 Cypress Ct', city:'Sunnyvale, CA 94087', beds:3, baths:2, sqft:'1,800', badge:'New', badgeClass:'badge-green', ...agent(4), type:'House for sale', builder:'Brokered by Intero Real Estate' },
      { id:29, image:'https://picsum.photos/id/1036/600/400', price:'$1,350,000', address:'550 Dogwood Ln', city:'Sunnyvale, CA 94087', beds:4, baths:3.5, sqft:'2,800', badge:'Open House', badgeClass:'badge-blue', ...agent(5), type:'House for sale', builder:'Brokered by Keller Williams' },
      { id:30, image:'https://picsum.photos/id/1037/600/400', price:'$799,000', address:'660 Eucalyptus Ave', city:'Sunnyvale, CA 94086', beds:3, baths:2.5, sqft:'1,700', badge:'New', badgeClass:'badge-green', ...agent(0), type:'Townhouse for sale', builder:'Brokered by Intero Real Estate' },
      { id:31, image:'https://picsum.photos/id/1038/600/400', price:'$995,000', address:'770 Juniper Dr', city:'Sunnyvale, CA 94087', beds:4, baths:2, sqft:'2,150', badge:'Price Drop', badgeClass:'badge-red', ...agent(1), type:'House for sale', builder:'Brokered by Zillow Premier' },
      { id:32, image:'https://picsum.photos/id/1039/600/400', price:'$1,450,000', address:'880 Linden Pl', city:'Sunnyvale, CA 94087', beds:5, baths:3, sqft:'3,000', badge:'New', badgeClass:'badge-blue', ...agent(2), type:'House for sale', builder:'Brokered by Sotheby\'s' },
      { id:33, image:'https://picsum.photos/id/1040/600/400', price:'$625,000', address:'990 Olive Blvd', city:'Sunnyvale, CA 94086', beds:2, baths:2, sqft:'1,250', badge:'Open House', badgeClass:'badge-green', ...agent(3), type:'Condo for sale', builder:'Brokered by Berkshire Hathaway' },
      { id:34, image:'https://picsum.photos/id/1041/600/400', price:'$2,250,000', address:'111 Palm Way', city:'Sunnyvale, CA 94087', beds:5, baths:4.5, sqft:'3,600', badge:'Premium', badgeClass:'badge-blue', ...agent(4), type:'House for sale', builder:'Brokered by Compass' },
      { id:35, image:'https://picsum.photos/id/1042/600/400', price:'$1,275,000', address:'222 Pecan Cir', city:'Sunnyvale, CA 94087', beds:4, baths:3, sqft:'2,650', badge:'New', badgeClass:'badge-green', ...agent(5), type:'House for sale', builder:'Brokered by Sereno Group' },
      { id:36, image:'https://picsum.photos/id/1043/600/400', price:'$865,000', address:'333 Quince Ave', city:'Sunnyvale, CA 94086', beds:3, baths:2, sqft:'1,950', badge:'Price Drop', badgeClass:'badge-red', ...agent(0), type:'House for sale', builder:'Brokered by First Team' },
    ],
  },
};
